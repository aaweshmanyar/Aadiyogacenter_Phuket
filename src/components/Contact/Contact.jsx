...
const Contact = () => {
  ...
  const form = useRef(null); // Reference to the form for Google Sheets submission
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbyxOHCLGvXBPaAvxOF7DrKhVR76fkfR1zchlFvzAPLn3eWAey_AY5qZGLMP_RgkUH6XtQ/exec"; // Replace with your Google Apps Script URL
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            ...
            <div className="mt-8 space-y-4 text-lg">
              ...
              <div>
                ...
                80, Doctor wattana, 16 Soi Dr. Watthana, Pa Tong, Phuket, 83150, Thailand
                </p>
              </div>
              {/* Opening Hours */}
              <div>
          ...
          >
            ...
            {/* Phone input converted to a normal input field */}
            <input
              className={`form-control ${
