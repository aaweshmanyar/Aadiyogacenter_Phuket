      ...
      <div className="flex items-center">
        <div className="flex gap-x-4 lg:gap-x-9">
          {user ? (
            ...
            <button
              className="btn btn-md lg:px-[30px] bg-green-300 border border-green text-green-300 font-medium text-sm lg:text-base hover:bg-green-200 hover:text-white text-white transition"
